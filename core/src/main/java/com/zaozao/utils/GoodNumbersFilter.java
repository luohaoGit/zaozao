...
/**
 * Created by luohao on 15/12/14.
 */
public class GoodNumbersFilter {
    ...
    static private void init() {
        ...
        levitPatterns.add("^\\d*(1688|2688|2088|2008|5188|10010|10001|666|888|668|686|688|866|868|886|999|998|88)\\d*$");
        // 重复号码，镜子号码
